...
const initialState = {
  ...
  cabinet: '',
  previousCabinets: [] as { name: string; practices: string[] }[],
  cabNat: '',
  cabTier: '',
  departement: '',
  ...
  taxConseilPct: 70,
  taxClients: [] as string[],
  taxCorporatePct: 20,
  taxTransacPct: 20,
  taxHasPatrimonial: null as boolean | null,
  taxPatrimonialPct: 10,
  taxPatrimonialTypes: [] as string[],
  taxHasPrixTransfert: null as boolean | null,
  taxPrixTransfertPct: 10,
  taxHasTva: null as boolean | null,
  taxTvaPct: 10,
  taxInternationalPct: 20,
  // Droit Public
  dpubPublique: 50,
  dpubCtxDefense: 50,
  dpubDomestique: 50,
