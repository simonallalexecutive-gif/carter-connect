...
import heroVideoAsset from '@/assets/hero-video-harvey-style-v2.mp4.asset.json';
    ...
    <section className="min-h-screen md:min-h-[115vh] flex flex-col justify-center relative overflow-hidden bg-black">
      ...
      <div className="px-6 sm:px-8 lg:px-10 max-w-6xl relative z-10 pt-24 flex-1 flex items-center">
        <motion.div variants={stagger} initial="hidden" animate="visible" className="max-w-3xl">
          ...
          <motion.h1 variants={fadeUp} className="text-[3.25rem] sm:text-[3.9rem] md:text-[5.3rem] lg:text-[7.8rem] font-serif font-[500] text-white leading-[1.05] md:leading-[1.02] mb-3 md:mb-4 tracking-[-0.03em]">
            Connecting<br /><span className="text-white/70">Legal Minds</span>
          </motion.h1>
