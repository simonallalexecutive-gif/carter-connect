        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-8 lg:px-10 relative z-10 py-32 md:py-44 w-full">
          <div className="flex flex-col items-center text-center">
            ...
            <motion.div
              ...
              className="mt-24 mx-auto flex flex-row flex-wrap items-center justify-center gap-x-6 gap-y-3 sm:gap-x-16 md:gap-x-24"
            >
              {['CONFIDENTIEL', 'STRUCTURÉ', 'DÉCISIF'].map((word, i) => (
                <motion.span
                  ...
                  className="font-serif text-sm sm:text-lg md:text-2xl text-white tracking-[0.04em]"
                >
                  {word}
                </motion.span>
              ))}
