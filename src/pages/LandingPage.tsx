  ...
  <div className="min-h-screen bg-background">
    ...
    <section className="min-h-screen flex flex-col justify-center relative overflow-hidden bg-black">
      ...
      <div className="px-6 sm:px-8 lg:px-10 max-w-6xl relative z-10 pt-24 flex-1 flex items-center">
          ...
          <motion.h1 variants={fadeUp} className="text-5xl md:text-7xl lg:text-[5.5rem] font-display font-normal text-white leading-[1.08] mb-8 tracking-[-0.01em]">
      ...
      <div className="carter-container">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-2xl sm:text-3xl md:text-4xl lg:text-[3.15rem] font-serif font-normal text-white leading-[1.2] italic tracking-[-0.01em] mb-8"
          >
