  ...
  <div className="min-h-screen bg-background">
    ...
    <section className="min-h-screen flex flex-col justify-center relative overflow-hidden bg-black">
      ...
      <div className="px-6 sm:px-8 lg:px-10 max-w-6xl relative z-10 pt-24 flex-1 flex items-center">
          ...
          <motion.p variants={fadeUp} className="text-lg md:text-2xl text-white font-sans font-bold max-w-2xl mb-3 leading-relaxed whitespace-nowrap">
            La plateforme confidentielle de mise en relation entre avocats d'affaires<br />et cabinets de premier plan.
          </motion.p>
