    ...
    <section className="min-h-screen md:min-h-[115vh] flex flex-col justify-center relative overflow-hidden bg-black">
      ...
      <div className="px-6 sm:px-8 lg:px-10 max-w-6xl relative z-10 pt-24 flex-1 flex items-center">
        <motion.div variants={stagger} initial="hidden" animate="visible" className="max-w-3xl">
          ...
          <motion.h1 variants={fadeUp} className="text-[3.8rem] sm:text-[4.6rem] md:text-[6.35rem] lg:text-[9.25rem] font-serif font-[500] text-white leading-[1.05] md:leading-[1.02] mb-6 md:mb-8 tracking-[-0.03em]">
            Connecting <em className="italic">top-tier</em>{' '}<span className="text-white/70">legal minds</span>
          </motion.h1>
          <motion.p variants={fadeUp} className="text-[1.05rem] sm:text-[1.18rem] md:text-[1.32rem] text-white font-sans font-semibold max-w-2xl mb-3 leading-relaxed">
