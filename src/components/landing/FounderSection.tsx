    ...
    <section className="py-20 md:py-28 bg-foreground overflow-hidden">
      <div className="carter-container">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Founder — photo+name left, bio right */}
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.9, ease: [0.16, 1, 0.3, 1], delay: 0.15 }}
            className="flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-14 max-w-3xl mx-auto"
          >
            {/* Left — photo + name */}
            <div className="flex flex-col items-center flex-shrink-0">
              <div className="w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden ring-2 ring-white/10 mb-4">
                <img
                  src={founderPhoto}
                  alt="Simon Allal"
            ...
            {/* Right — bio */}
            <div className="text-center md:text-left flex-1 pt-0 md:pt-4">
