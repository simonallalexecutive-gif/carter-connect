    ...
    <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-10 lg:px-16 py-28 md:py-40">
      ...
      >
        ...
        <motion.div variants={fadeUp} className="px-0 md:pl-12 py-10 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-5">
            <p className="font-sans font-light text-[1.01rem] leading-[1.8] text-black/55 text-justify">
              <span className="text-black/75 font-bold">Restez en alerte et attractif</span> : soyez notifié de toute nouvelle opportunité ou marque d'intérêt d'un cabinet pour votre profil accessible sur une base anonymisée.
            </p>
            <div className="w-4 h-px bg-black/10" />
            <p className="font-sans font-light text-[1.01rem] leading-[1.8] text-black/55 text-justify">
              <span className="text-black/75 font-bold">Un consultant dédié</span> : lorsqu'une opportunité s'inscrit dans votre projet, Logan vous accompagne de la mise en relation à la finalisation de votre processus.
            </p>
          </div>
        </motion.div>
      </motion.div>
