    ...
    <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-10 lg:px-16 py-28 md:py-40">
      ...
      >
        ...
        <motion.div variants={fadeUp} className="px-0 md:pr-12 py-10 flex flex-col gap-6">
          <span className="text-[12px] font-sans font-bold tracking-[0.22em] uppercase text-black/30">Firms</span>
          <h3 className="font-serif font-[300] text-[1.07rem] text-black leading-snug italic">
            Vivez votre marché.
          </h3>
          <div className="flex flex-col gap-5">
            <p className="font-sans font-light text-[0.92rem] sm:text-[0.97rem] leading-[1.9] text-black/60 text-justify">
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-4 w-full justify-center">
            ...
            <div className="flex items-center gap-0.5">
              ...
              />
              <span className="text-black/20 text-[8.5px]">›</span>
            </div>

            <span className="text-[12px] font-sans font-bold tracking-[0.22em] uppercase text-black/60 shrink-0">Logan</span>
          ...
          {/* Mobile : juste Logan */}
          <span className="md:hidden text-[12px] font-sans font-bold tracking-[0.22em] uppercase text-black/60">Logan</span>

          <p className="font-sans font-light text-[0.92rem] sm:text-[0.97rem] leading-[1.9] text-black/60 text-center max-w-[200px]">
        ...
        <motion.div variants={fadeUp} className="px-0 md:pl-12 py-10 flex flex-col gap-6">
          <span className="text-[12px] font-sans font-bold tracking-[0.22em] uppercase text-black/30">Candidats</span>
          <h3 className="font-serif font-[300] text-[1.07rem] text-black leading-snug italic">
