...
const FonctionnementSection = () => (
  <section className="relative bg-[hsl(0,0%,96%)] overflow-hidden">
    ...
    <div className="absolute inset-0 pointer-events-none">
      <div className="absolute top-0 right-0 w-[600px] h-[400px] bg-gradient-radial from-black/[0.015] to-transparent rounded-full blur-3xl" />
      <div className="absolute bottom-1/3 left-0 w-[500px] h-[300px] bg-gradient-radial from-black/[0.01] to-transparent rounded-full blur-3xl" />
    </div>
    ...
    <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-8 lg:px-10 py-24 md:py-36">
      ...
      >
        ...
        <motion.div variants={fadeUp} className="flex items-center gap-3">
          ...
          <p className="font-sans text-sm font-medium tracking-[0.15em] uppercase text-white/30">
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-10 mb-12">
          <div className="bg-white/[0.03] border border-white/[0.06] rounded-sm p-8 md:p-10">
            <div className="flex items-center gap-3 mb-6">
              <EyeOff className="w-5 h-5 text-white/25" strokeWidth={1.5} />
              <p className="font-sans text-xs font-semibold tracking-[0.2em] uppercase text-white/40">A. Mode confidentiel</p>
              <span className="ml-auto text-[10px] font-sans font-medium tracking-wider uppercase px-3 py-1 border border-white/15 rounded-sm text-white/35">
                Recommandé
              </span>
            </div>
          ...
          {/* B. Mode non confidentiel */}
          <div className="bg-white/[0.03] border border-white/[0.06] rounded-sm p-8 md:p-10">
            <div className="flex items-center gap-3 mb-6">
              <Eye className="w-5 h-5 text-white/25" strokeWidth={1.5} />
              <p className="font-sans text-xs font-semibold tracking-[0.2em] uppercase text-white/40">B. Mode non confidentiel</p>
            </div>
            <p className="font-sans text-[0.95rem] leading-[1.75] text-white/55 mb-6">
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-sm p-8 md:p-10 mb-12">
      ...
      >
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-sm p-8 md:p-10 mb-10">
        ...
        {/* Concrete example */}
        <div className="bg-white/[0.02] border border-dashed border-white/[0.08] rounded-sm p-8 md:p-10 mb-10">
