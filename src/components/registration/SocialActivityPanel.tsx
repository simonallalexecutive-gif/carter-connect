          ...
          <div className="lg:w-[45%] space-y-5">
            ...
            <div className="space-y-3 pt-3 border-t border-border">
              ...
              <div className="space-y-1">
                ...
                <Slider value={[conseilPct]} onValueChange={([v]) => store.setField('socialConseil', v)} min={0} max={100} step={5} className="w-full" />
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
            ...
            <div className="space-y-3 pt-3 border-t border-border">
              ...
              <div className="space-y-1">
                ...
                <Slider value={[employeurPct]} onValueChange={([v]) => store.setField('socialEmployeur', v)} min={0} max={100} step={5} className="w-full" />
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
