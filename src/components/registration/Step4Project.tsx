    ...
    >
      ...
      <div className="flex justify-between items-center pt-10">
        <Button variant="outline" onClick={store.prevStep} className="font-sans font-light rounded-sm gap-2">
          ...
          <Button onClick={store.nextStep} disabled={selected.length === 0} className="bg-foreground text-background hover:bg-foreground/90 font-sans font-medium rounded-sm gap-2">
            Continuer
