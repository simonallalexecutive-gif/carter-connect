      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 pb-16 border-b border-white/10">
        ...
        <div>
          ...
          <p className="font-sans text-sm text-white/50 font-light leading-relaxed mb-6">
            Vous souhaitez en savoir plus sur Carter ? Prenons rendez-vous.
          </p>
          <Link to="/contact">
            <Button variant="outline" className="border-white/20 text-white hover:bg-white hover:text-black font-sans text-sm font-medium rounded-sm px-6 py-5 group transition-all duration-300">
              Prendre rendez-vous
