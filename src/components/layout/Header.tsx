    ...
    >
      <div className="px-6 sm:px-8 lg:px-10 flex items-center justify-between h-16">
        <div className="flex items-center gap-6">
          ...
          <nav className="hidden md:flex items-center gap-1 ml-2">
            ...
            <Link to="/role-de-logan" className={leftNavLinkBase}>Le rôle de Logan</Link>
      ...
      {menuOpen && (
        <div className="md:hidden bg-black min-h-[calc(100dvh-4rem)] flex flex-col px-6 pt-8 pb-12 gap-5 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <Link to="/role-de-logan" onClick={() => setMenuOpen(false)} className="font-sans text-base font-normal text-white/80 hover:text-white transition-colors tracking-wide">Le rôle de Logan</Link>
