...
export const LEGAL500_DB: Record<string, FirmEntry> = {
  ...
  'Alerion':                          { nat: 'FR', rankings: { ma: 6, restructuring: 4 } },
  ...
  'August Debouzy':                   { nat: 'FR', rankings: { ma: 4, pe: 3, social: 1, immo: 2, fiscal: 4, restructuring: 3 } },
  // ── B ──
  ...
  'BG2V':                             { nat: 'FR', rankings: { ma: 6, immo: 3, social: 4 } },
  'Bignon Lebray':                    { nat: 'FR', rankings: { pe: 4 } },
  'Bird & Bird':                      { nat: 'UK', rankings: { ma: 5, banque: 4, social: 4, fiscal: 5, restructuring: 3 } },
  ...
  'Chammas & Marcheteau':             { nat: 'FR', rankings: { fiscal: 5, restructuring: 4 } },
  'Charles Russell Speechlys':        { nat: 'UK', rankings: { social: 4 } },
  ...
  'Couderc Dinh & Associés':          { nat: 'FR', rankings: { fiscal: 5 } },
  // ── D ──
  ...
  'Delsol Avocats':                   { nat: 'FR', rankings: { ma: 5, social: 4, fiscal: 5 } },
  'Dentons':                          { nat: 'UK', rankings: { ma: 5, pe: 4, banque: 3, projets: 4, social: 3, immo: 4, fiscal: 4, restructuring: 4 } },
  ...
  'FIDAL':                            { nat: 'FR', rankings: { ma: 6, pe: 4, banque: 4, social: 4, fiscal: 5, restructuring: 4 } },
  ...
  'FTPA':                             { nat: 'FR', rankings: { ma: 5, pe: 4, fiscal: 5, restructuring: 3 } },
  // ── G ──
  ...
  'Gide Loyrette Nouel':              { nat: 'FR', rankings: { ma: 2, pe: 2, banque: 2, projets: 1, social: 1, immo: 1, fiscal: 2, restructuring: 4 } },
  'Goodwin Procter':                  { nat: 'US', rankings: { ma: 4, pe: 2, banque: 3, fiscal: 3 } },
  // ── H ──
  ...
  'Hogan Lovells':                    { nat: 'US', rankings: { ma: 4, pe: 2, banque: 2, projets: 3, social: 2, immo: 5, fiscal: 3, restructuring: 1 } },
  ...
  'Joffe & Associés':                 { nat: 'FR', rankings: { ma: 6, pe: 4, banque: 4, social: 4 } },
  'Jones Day':                        { nat: 'US', rankings: { ma: 4, banque: 4, social: 3, immo: 3, projets: 3, fiscal: 4, restructuring: 2 } },
  // ── K ──
  ...
  'Latham & Watkins':                 { nat: 'US', rankings: { ma: 3, pe: 1, banque: 1, social: 3, fiscal: 1, restructuring: 1 } },
  ...
  'McDermott Will & Emery':           { nat: 'US', rankings: { ma: 5, pe: 2, fiscal: 2, restructuring: 3 } },
  ...
  'Morgan, Lewis & Bockius LLP':      { nat: 'US', rankings: { ma: 6, banque: 4 } },
  // ── N ──
  ...
  'Orrick Herrington & Sutcliffe':    { nat: 'US', rankings: { ma: 4, pe: 3, projets: 2, social: 2, immo: 5, fiscal: 5, restructuring: 3 } },
  ...
  'Proskauer Rose':                   { nat: 'US', rankings: { ma: 6, pe: 2, banque: 3 } },
  ...
  'Reed Smith':                       { nat: 'US', rankings: { ma: 6, immo: 4, banque: 0, fiscal: 5 } },
  ...
  'Sekri Valentin Zerrouk':           { nat: 'FR', rankings: { ma: 5, pe: 3, banque: 4, immo: 0, fiscal: 5 } },
  ...
  // ── T ──
  'Taylor Wessing':                   { nat: 'UK', rankings: { ma: 6, social: 4, immo: 5 } },
  ...
  // ── U ──
  'UGGC Avocats':                     { nat: 'FR', rankings: { ma: 5, banque: 4, social: 3, immo: 5, restructuring: 4 } },
  // ── V ──
  ...
  'Viguié Schmidt & Associés':        { nat: 'FR', rankings: { ma: 4 } },
  'Villechenon':                      { nat: 'FR', rankings: { pe: 4 } },
  ...
  'White & Case':                     { nat: 'US', rankings: { ma: 3, pe: 2, banque: 1, projets: 1, social: 3, immo: 3, fiscal: 3, restructuring: 1 } },
  ...
  // ── Y ──
  'YARDS':                            { nat: 'FR', rankings: { pe: 4, social: 4, fiscal: 5 } },
};
