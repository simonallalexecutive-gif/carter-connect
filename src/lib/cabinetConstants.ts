...
export const PROFILES: CabinetProfile[] = [
  {
    ...
    expertise: ['Financement', 'Private Equity'],
  ...
  },
  {
    ...
    expertise: ['M&A', 'Private Equity'],
    split: { 'M&A': 70, 'Private Equity': 30 },
  ...
  },
  {
    ...
    origin: 'Cabinet français Tier 1', originTier: 'Tier 1',
    english: 'Courant', seniority: 'Mid Level', isNew: true,
    expertise: ['Fiscal', 'M&A'],
    split: { 'Fiscal': 75, 'M&A': 25 },
  ...
  },
  {
    ...
    expertise: ['M&A', 'Private Equity', 'Droit boursier'],
    split: { 'M&A': 50, 'Private Equity': 30, 'Droit boursier': 20 },
  ...
  },
  {
    ...
    expertise: ['Financement', 'Private Equity', 'Restructuring'],
    split: { 'Financement': 50, 'Private Equity': 30, 'Restructuring': 20 },
  ...
  },
  {
    ...
    expertise: ['M&A', 'Droit boursier'],
    split: { 'M&A': 70, 'Droit boursier': 30 },
  ...
  },
  {
    ...
    expertise: ['Private Equity', 'M&A'],
    split: { 'Private Equity': 65, 'M&A': 35 },
  ...
  },
  {
    ...
    expertise: ['Financement', 'Restructuring', 'Private Equity'],
    split: { 'Financement': 55, 'Restructuring': 25, 'Private Equity': 20 },
  ...
  },
  {
    ...
    expertise: ['Fiscal', 'Private Equity'],
    split: { 'Fiscal': 60, 'Private Equity': 40 },
