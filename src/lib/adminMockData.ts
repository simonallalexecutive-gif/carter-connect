...
export const MOCK_PROFILES: AdminProfile[] = [
  ...
  { id: 'LGN-C-004', fullName: 'Sophie Chen', email: 's.chen@email.com', dept: 'Banque & Finance', pqe: '6', origin: 'Gide Loyrette Nouel', status: 'qualifié', createdAt: '2026-03-07', mobilite: 'Paris / Singapour', anglais: 'Bilingue' },
